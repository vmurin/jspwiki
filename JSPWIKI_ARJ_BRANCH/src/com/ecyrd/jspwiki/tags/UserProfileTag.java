...
/**
*  <p>Returns user profile attributes, or empty strings if the user has not been
*  validated. This tag has a single attribute, "property," which may contain
*  one of the following case-insensitive values:</p>
*  <ul>
*    <li>email</li>
*    <li>fullname</li>
*    <li>loginname</li>
...
public class UserProfileTag extends WikiTagBase
{
    ...
    public final int doWikiStartTag() throws IOException
    {
        ...
        {
            pageContext.getOut().print( "(not set)" );
        }
