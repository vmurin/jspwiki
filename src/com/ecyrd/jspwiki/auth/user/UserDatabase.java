...
public interface UserDatabase
{
     ...
     * appropriately. Implementing classes that persist to the file 
     * system may wish to make this method <code>synchronized</code>.
     ...
     * These are defined as a set of Principals manufactured from
     * the login name, full name, and wiki name. The order of the principals
     * returned is significant: the first one returned is considered to be
     * the "primary" user principal. As such, this should generally be the
     * Principal that represents the user's full name.
    ...
    /**
     * Initializes the user database based on values from a Properties
     * object.
     */
     ...
     * a login name and password. It is up to the implementing class
     * to determine how the comparison should be made. For example, 
     * the password might be hashed before comparing it to the value
